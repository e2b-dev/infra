...
func NewReservationCache() *ReservationStore {
	return &ReservationStore{
		reservations: smap.New[*Reservation](),
	}
}

func (r *ReservationStore) insertIfAbsent(sandboxID string, team uuid.UUID) bool {
...
func (r *ReservationStore) release(sandboxID string) {
	r.reservations.Remove(sandboxID)
}

func (r *ReservationStore) list(teamID uuid.UUID) (sandboxIDs []string) {
