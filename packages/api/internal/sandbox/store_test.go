...
func TestAdd_NewSandbox(t *testing.T) {
	t.Run("success - all callbacks called", func(t *testing.T) {
		...
		callbacks := sandbox.Callbacks{
			AddSandboxRouting:        tracker.Track("AddSandboxRouting"),
		...
		tracker.AssertCallCount(t, "AddSandboxRouting", 1)
...
func TestAdd_AlreadyInCache(t *testing.T) {
	t.Run("newlyCreated=true - AsyncSandboxCounter NOT called when already in cache", func(t *testing.T) {
		...
		callbacks1 := sandbox.Callbacks{
			AddSandboxRouting:        tracker1.Track("AddSandboxRouting"),
		...
		callbacks2 := sandbox.Callbacks{
			AddSandboxRouting:        tracker2.Track("AddSandboxRouting"),
		...
		require.NoError(t, err)
		tracker2.AssertCallCount(t, "AddSandboxRouting", 1)
	...
	t.Run("newlyCreated=false - only AddSandboxRouting called when already in cache", func(t *testing.T) {
		ctx := t.Context()
...
func TestAdd_NotNewlyCreated(t *testing.T) {
	t.Run("not in cache - AddSandboxRouting and AsyncSandboxCounter called", func(t *testing.T) {
		ctx := t.Context()
	...
	t.Run("already in cache - only AddSandboxRouting called", func(t *testing.T) {
		ctx := t.Context()
...
func TestAdd_StorageErrors(t *testing.T) {
	t.Run("storage returns non-ErrAlreadyExists error", func(t *testing.T) {
		...
		tracker.AssertNotCalled(t, "AddSandboxRouting")
...
func TestAdd_ConcurrentCalls(t *testing.T) {
	t.Run("concurrent adds for different sandboxes", func(t *testing.T) {
		...
		tracker.AssertCallCount(t, "AddSandboxRouting", numGoroutines)
