...
type Storage interface { //nolint: interfacebloat
	...
	StartRemoving(ctx context.Context, teamID uuid.UUID, sandboxID string, stateAction StateAction, eviction bool) (Sandbox, bool, func(context.Context, error), error)
...
func (s *Store) StartRemoving(ctx context.Context, teamID uuid.UUID, sandboxID string, stateAction StateAction, eviction bool) (Sandbox, bool, func(context.Context, error), error) {
	return s.storage.StartRemoving(ctx, teamID, sandboxID, stateAction, eviction)
}
