...
func (o *Orchestrator) observeTeamSandbox(ctx context.Context, sandbox *store.Sandbox, created bool) {
	o.teamMetricsObserver.Add(ctx, sandbox.TeamID, created)
}

func (o *Orchestrator) addToNode(ctx context.Context, sandbox *store.Sandbox, _ bool) {
