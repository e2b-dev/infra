...
func New(
	...
	var routingCatalog sandboxcatalog.SandboxesCatalog
	if redisClient != nil {
		routingCatalog = sandboxcatalog.NewRedisSandboxCatalog(redisClient)
	} else {
		routingCatalog = sandboxcatalog.NewMemorySandboxesCatalog()
	}
