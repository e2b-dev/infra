...
func (n *Node) GetSandboxCreateCtx(ctx context.Context, req *orchestrator.SandboxCreateRequest) (*clusters.GRPCClient, context.Context) {
	...
	// return n.connection, metadata.AppendToOutgoingContext(ctx, args...)

	// Merge medata from client connection (auth, routing with service instance id) and event metadata.
