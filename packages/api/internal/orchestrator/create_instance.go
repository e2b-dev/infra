...
func (o *Orchestrator) CreateSandbox(
	...
	node, err = placement.PlaceSandbox(ctx, o.placementAlgorithm, clusterNodes, node, sbxRequest, buildMachineInfo, labelFilteringEnabled, team.SandboxSchedulingLabels)
	if err != nil {
		return sandbox.Sandbox{}, &api.APIError{
			Code:      http.StatusInternalServerError,
