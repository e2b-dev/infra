...
func TestPlaceSandbox_SuccessfulPlacement(t *testing.T) {
	...
	resultNode, err := PlaceSandbox(ctx, algorithm, nodes, nil, sbxRequest, false, machineinfo.MachineInfo{}, false, nil)
...
func TestPlaceSandbox_WithPreferredNode(t *testing.T) {
	...
	resultNode, err = PlaceSandbox(ctx, algorithm, nodes, node2, sbxRequest, false, machineinfo.MachineInfo{}, false, nil)
	require.NoError(t, err)
	assert.NotNil(t, resultNode)
	assert.Equal(t, node2, resultNode)
...
func TestPlaceSandbox_ContextTimeout(t *testing.T) {
	...
	}, nil, sbxRequest, false, machineinfo.MachineInfo{}, false, nil)
...
func TestPlaceSandbox_NoNodes(t *testing.T) {
	...
	resultNode, err := PlaceSandbox(ctx, algorithm, []*nodemanager.Node{}, nil, sbxRequest, false, machineinfo.MachineInfo{}, false, nil)
