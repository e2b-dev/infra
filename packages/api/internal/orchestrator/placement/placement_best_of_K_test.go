...
func TestBestOfK_ChooseNode(t *testing.T) {
	...
	selected, err := algo.chooseNode(ctx, nodes, excludedNodes, resources, machineinfo.MachineInfo{}, nil)
...
func TestBestOfK_Sample(t *testing.T) {
	...
	sampled := algo.sample(nodes, config, excludedNodes, resources, machineinfo.MachineInfo{}, nil)
