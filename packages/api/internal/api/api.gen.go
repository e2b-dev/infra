...
type ServerInterface interface {
	...
	// (POST /templates/tags/{name})
	PostTemplatesTagsName(c *gin.Context, name string)
...
// PostTemplatesTagsName operation middleware
func (siw *ServerInterfaceWrapper) PostTemplatesTagsName(c *gin.Context) {
	...
	siw.Handler.PostTemplatesTagsName(c, name)
}
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.POST(options.BaseURL+"/templates/tags/:name", wrapper.PostTemplatesTagsName)
