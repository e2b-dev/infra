...
func (a *APIStore) PostSandboxes(c *gin.Context) {
	...
	if err != nil {
		...
		apiErr.Report(ctx, "error when resolving template alias", attribute.String("identifier", identifier))
	...
	if err != nil {
		...
		apiErr.Report(ctx, "error when getting template", telemetry.WithTemplateID(aliasInfo.TemplateID))
		a.sendAPIStoreError(c, apiErr.Code, apiErr.ClientMsg)
