...
const sandboxMetricsTimeRangeSelectQuery = `
    ...
    WHERE Attributes['sandbox_id'] = 'iawmddux18qj3m0ifwfop'
      AND Attributes['team_id'] = '460355b3-4f64-48f9-9a16-4442817f79f5'
`
...
func (c *Client) QuerySandboxTimeRange(ctx context.Context, sandboxID string, teamID string) (time.Time, time.Time, error) {
	// we can't use time.Time, because the time is Datetime64
