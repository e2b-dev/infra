...
func main() {
	...
	err = doBuild(ctx, *templateID, *toBuild, *fromBuild, *kernel, *fc, *vcpu, *memory, *disk, *hugePages, fprOverride, *startCmd, *setupCmd, *readyCmd, localMode, *verbose, builderConfig, networkConfig)
	if err != nil {
		log.Fatal(err)
	}
}
