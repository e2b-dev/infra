...
import (
	...
	handler "github.com/e2b-dev/infra/packages/orchestrator/internal/sandbox/uffd/userfaultfd"
...
func (u *Uffd) handle(sandboxId string) error {
	...
	var mappings firecracker.FcMappings
	...
	handler := handler.NewUserfaultfdFromFd(uintptr(fds[0]), false)
