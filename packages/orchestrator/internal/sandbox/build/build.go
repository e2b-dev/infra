...
// Slice returns the data at the given offset and length.
// It delegates to ReadAt which handles mixed-granularity mappings (e.g. 4KiB dedup pages alongside 2MB template ranges).
