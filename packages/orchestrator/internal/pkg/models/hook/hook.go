...
// The SandboxFunc type is an adapter to allow the use of ordinary
// function as Sandbox mutator.
type SandboxFunc func(context.Context, *models.SandboxMutation) (models.Value, error)

// Mutate calls f(ctx, m).
func (f SandboxFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	if mv, ok := m.(*models.SandboxMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *models.SandboxMutation", m)
}

// The StatusFunc type is an adapter to allow the use of ordinary
// function as Status mutator.
type StatusFunc func(context.Context, *models.StatusMutation) (models.Value, error)

// Mutate calls f(ctx, m).
func (f StatusFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	if mv, ok := m.(*models.StatusMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *models.StatusMutation", m)
}
