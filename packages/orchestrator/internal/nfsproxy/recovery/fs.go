...
func (fs *filesystem) tryRecoveryWithError(message string, err error) error { // deprecated
	// kept for backward compatibility if referenced elsewhere in the project
	return err
}
