...
func Delete(ctx context.Context, artifactRegistry artifactsregistry.ArtifactsRegistry, templateStorage *storage.Provider, templateId string, buildId string) error {
