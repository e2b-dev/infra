...
func (b *Builder) applyCommand(
	...
	telemetry.ReportEvent(ctx, "command metadata",
		attribute.String("user", cmdMetadata.User),
		attribute.String("workdir", utils.Sprintp(cmdMetadata.WorkDir)),
		attribute.String("env_vars", fmt.Sprintf("%v", cmdMetadata.EnvVars)),
	)
