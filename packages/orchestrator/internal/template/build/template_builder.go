...
// 6. Snapshot
// 7. Upload template
func (b *TemplateBuilder) Build(ctx context.Context, template *templateconfig.TemplateConfig, logsWriter io.Writer, engineConfig *templatemanager.EngineConfig) (r *Result, e error) {
...
func (b *TemplateBuilder) pauseAndUpload(
	...
	uploadErrGroup.Go(func() error {
		...
		err = saveTemplateToHash(ctx, persistance, snapshotTemplateFiles.TemplateId, baseHash, hash, TemplateMetadata{
