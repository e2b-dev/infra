...
func (m *BuildMetrics) RecordBuildResult(ctx context.Context, success bool, errorType string) {
	attrs := []attribute.KeyValue{
		attribute.Bool("success", success),
	}
...
// GetErrorType categorizes build errors into types for metrics
func GetErrorType(err error) string {
	...
	case strings.Contains(errStr, "memory"):
		return "memory"
	case strings.Contains(errStr, "disk"):
		return "disk"
