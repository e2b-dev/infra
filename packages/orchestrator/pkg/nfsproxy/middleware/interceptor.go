...
type Interceptor func(ctx context.Context, op string, args []any, next func(context.Context) ([]any, error)) ([]any, error)
...
func (c *Chain) Exec(ctx context.Context, op string, args []any, fn func(context.Context) ([]any, error)) ([]any, error) {
	wrapped := fn
