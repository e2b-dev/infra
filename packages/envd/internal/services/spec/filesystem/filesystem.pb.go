...
var file_filesystem_filesystem_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0xe1, 0x02, 0x0a,
	...
	0x72, 0x74, 0x12, 0x4e, 0x0a, 0x0a, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x79, 0x73,
	0x74, 0x65, 0x6d, 0x2e, 0x57, 0x61, 0x74, 0x63, 0x68, 0x44, 0x69, 0x72, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x45,
	...
	0x61, 0x72, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x1a, 0x50, 0x0a, 0x0f, 0x46, 0x69, 0x6c, 0x65,
	...
	0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x1a, 0x0b, 0x0a, 0x09, 0x4b, 0x65,
	...
	0x94, 0x03, 0x0a, 0x0a, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x39,
	...
	0x74, 0x44, 0x69, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x47, 0x0a, 0x08,
	...
	0x65, 0x6d, 0x2e, 0x57, 0x61, 0x74, 0x63, 0x68, 0x44, 0x69, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x3f, 0x0a, 0x06, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x12,
...
var file_filesystem_filesystem_proto_depIdxs = []int32{
	...
	15, // 5: filesystem.WatchDirResponse.start:type_name -> filesystem.WatchDirResponse.StartEvent
	16, // 6: filesystem.WatchDirResponse.filesystem:type_name -> filesystem.WatchDirResponse.FilesystemEvent
	17, // 7: filesystem.WatchDirResponse.keepalive:type_name -> filesystem.WatchDirResponse.KeepAlive
	1,  // 8: filesystem.WatchDirResponse.FilesystemEvent.type:type_name -> filesystem.EventType
	8,  // 9: filesystem.Filesystem.Stat:input_type -> filesystem.StatRequest
	4,  // 10: filesystem.Filesystem.MakeDir:input_type -> filesystem.MakeDirRequest
	2,  // 11: filesystem.Filesystem.Move:input_type -> filesystem.MoveRequest
	11, // 12: filesystem.Filesystem.ListDir:input_type -> filesystem.ListDirRequest
	13, // 13: filesystem.Filesystem.WatchDir:input_type -> filesystem.WatchDirRequest
	6,  // 14: filesystem.Filesystem.Remove:input_type -> filesystem.RemoveRequest
	9,  // 15: filesystem.Filesystem.Stat:output_type -> filesystem.StatResponse
	5,  // 16: filesystem.Filesystem.MakeDir:output_type -> filesystem.MakeDirResponse
	3,  // 17: filesystem.Filesystem.Move:output_type -> filesystem.MoveResponse
	12, // 18: filesystem.Filesystem.ListDir:output_type -> filesystem.ListDirResponse
	14, // 19: filesystem.Filesystem.WatchDir:output_type -> filesystem.WatchDirResponse
	7,  // 20: filesystem.Filesystem.Remove:output_type -> filesystem.RemoveResponse
