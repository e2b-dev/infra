...
var (
	...
	AccessTokensColumns = []*schema.Column{
		...
		{Name: "access_token_prefix", Type: field.TypeString, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "access_token_length", Type: field.TypeInt},
		{Name: "access_token_mask_prefix", Type: field.TypeString, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "access_token_mask_suffix", Type: field.TypeString, SchemaType: map[string]string{"postgres": "text"}},
	...
	TeamAPIKeysColumns = []*schema.Column{
		...
		{Name: "api_key_prefix", Type: field.TypeString, SchemaType: map[string]string{"postgres": "character varying(44)"}},
		{Name: "api_key_length", Type: field.TypeInt},
		{Name: "api_key_mask_prefix", Type: field.TypeString, SchemaType: map[string]string{"postgres": "character varying(44)"}},
		{Name: "api_key_mask_suffix", Type: field.TypeString, SchemaType: map[string]string{"postgres": "character varying(44)"}},
		{Name: "created_at", Type: field.TypeTime, Default: "CURRENT_TIMESTAMP"},
