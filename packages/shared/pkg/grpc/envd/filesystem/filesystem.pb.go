...
const file_filesystem_filesystem_proto_rawDesc = "" +
	...
	"\rRemoveWatcher\x12 .filesystem.RemoveWatcherRequest\x1a!.filesystem.RemoveWatcherResponseB\xac\x01\n" +
	"\x0ecom.filesystemB\x0fFilesystemProtoP\x01ZAgithub.com/e2b-dev/infra/packages/shared/pkg/grpc/envd/filesystem\xa2\x02\x03FXX\xaa\x02\n" +
	"Filesystem\xca\x02\n" +
