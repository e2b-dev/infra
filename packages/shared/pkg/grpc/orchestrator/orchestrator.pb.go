...
var file_orchestrator_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xc7, 0x01, 0x0a, 0x0e, 0x52, 0x75,
	...
	0x6f, 0x52, 0x06, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x73, 0x32, 0xbb, 0x03, 0x0a, 0x0e, 0x53, 0x61,
...
var file_orchestrator_proto_depIdxs = []int32{
	...
	21, // 15: RunningSandbox.start_time:type_name -> google.protobuf.Timestamp
	21, // 16: RunningSandbox.end_time:type_name -> google.protobuf.Timestamp
	14, // 17: SandboxListResponse.sandboxes:type_name -> RunningSandbox
	21, // 18: CachedBuildInfo.expiration_time:type_name -> google.protobuf.Timestamp
	16, // 19: SandboxListCachedBuildsResponse.builds:type_name -> CachedBuildInfo
	6,  // 20: SandboxService.Create:input_type -> SandboxCreateRequest
	8,  // 21: SandboxService.Update:input_type -> SandboxUpdateRequest
	22, // 22: SandboxService.List:input_type -> google.protobuf.Empty
	10, // 23: SandboxService.Delete:input_type -> SandboxDeleteRequest
	11, // 24: SandboxService.Pause:input_type -> SandboxPauseRequest
	12, // 25: SandboxService.Checkpoint:input_type -> SandboxCheckpointRequest
	22, // 26: SandboxService.ListCachedBuilds:input_type -> google.protobuf.Empty
	7,  // 27: SandboxService.Create:output_type -> SandboxCreateResponse
	22, // 28: SandboxService.Update:output_type -> google.protobuf.Empty
	15, // 29: SandboxService.List:output_type -> SandboxListResponse
	22, // 30: SandboxService.Delete:output_type -> google.protobuf.Empty
	22, // 31: SandboxService.Pause:output_type -> google.protobuf.Empty
	13, // 32: SandboxService.Checkpoint:output_type -> SandboxCheckpointResponse
	17, // 33: SandboxService.ListCachedBuilds:output_type -> SandboxListCachedBuildsResponse
