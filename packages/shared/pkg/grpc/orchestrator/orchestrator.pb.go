...
var file_orchestrator_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x86, 0x05, 0x0a, 0x0d, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x43, 0x6f,
	...
	0x6f, 0x78, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x1a, 0x3a, 0x0a, 0x0c, 0x45, 0x6e, 0x76, 0x56,
	...
	0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x22, 0xb2, 0x01, 0x0a, 0x14,
	...
	0x52, 0x09, 0x73, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x49, 0x64, 0x22, 0xc7, 0x01, 0x0a, 0x0e,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x06, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x73, 0x32, 0xbf, 0x02, 0x0a, 0x0e,
...
var file_orchestrator_proto_goTypes = []any{
	...
	(*CachedBuildInfo)(nil),                 // 7: CachedBuildInfo
	(*SandboxListCachedBuildsResponse)(nil), // 8: SandboxListCachedBuildsResponse
	nil,                                     // 9: SandboxConfig.EnvVarsEntry
	nil,                                     // 10: SandboxConfig.MetadataEntry
	(*timestamppb.Timestamp)(nil),           // 11: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),                   // 12: google.protobuf.Empty
}
var file_orchestrator_proto_depIdxs = []int32{
	9,  // 0: SandboxConfig.env_vars:type_name -> SandboxConfig.EnvVarsEntry
	10, // 1: SandboxConfig.metadata:type_name -> SandboxConfig.MetadataEntry
	0,  // 2: SandboxCreateRequest.sandbox:type_name -> SandboxConfig
	11, // 3: SandboxCreateRequest.start_time:type_name -> google.protobuf.Timestamp
	11, // 4: SandboxCreateRequest.end_time:type_name -> google.protobuf.Timestamp
	11, // 5: SandboxUpdateRequest.end_time:type_name -> google.protobuf.Timestamp
	0,  // 6: RunningSandbox.config:type_name -> SandboxConfig
	11, // 7: RunningSandbox.start_time:type_name -> google.protobuf.Timestamp
	11, // 8: RunningSandbox.end_time:type_name -> google.protobuf.Timestamp
	5,  // 9: SandboxListResponse.sandboxes:type_name -> RunningSandbox
	11, // 10: CachedBuildInfo.expiration_time:type_name -> google.protobuf.Timestamp
	7,  // 11: SandboxListCachedBuildsResponse.builds:type_name -> CachedBuildInfo
	1,  // 12: SandboxService.Create:input_type -> SandboxCreateRequest
	3,  // 13: SandboxService.Update:input_type -> SandboxUpdateRequest
	12, // 14: SandboxService.List:input_type -> google.protobuf.Empty
	4,  // 15: SandboxService.Delete:input_type -> SandboxDeleteRequest
	12, // 16: SandboxService.ListCachedBuilds:input_type -> google.protobuf.Empty
	2,  // 17: SandboxService.Create:output_type -> SandboxCreateResponse
	12, // 18: SandboxService.Update:output_type -> google.protobuf.Empty
	6,  // 19: SandboxService.List:output_type -> SandboxListResponse
	12, // 20: SandboxService.Delete:output_type -> google.protobuf.Empty
	8,  // 21: SandboxService.ListCachedBuilds:output_type -> SandboxListCachedBuildsResponse
