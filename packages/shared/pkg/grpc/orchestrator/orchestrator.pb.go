...
type SandboxCheckpointRequest struct {
	...
	SandboxId string `protobuf:"bytes,1,opt,name=sandbox_id,json=sandboxId,proto3" json:"sandbox_id,omitempty"`
	BuildId   string `protobuf:"bytes,3,opt,name=build_id,json=buildId,proto3" json:"build_id,omitempty"`
	// When true, the orchestrator consults the in-guest Inspector and
	// returns the previous snapshot's build_id (with unchanged=true) if
	// nothing recovery-relevant changed since then. Default false keeps
	// the historical "always pause" behavior. See issue #2580.
...
func (x *SandboxCheckpointRequest) GetSkipIfUnchanged() bool {
	if x != nil {
...
type SandboxCheckpointResponse struct {
	...
	// Set when the orchestrator short-circuited because the Inspector
	// reported no changes. The published_build_id below points at the
	// pre-existing snapshot the caller should use.
	Unchanged bool `protobuf:"varint,1,opt,name=unchanged,proto3" json:"unchanged,omitempty"`
	// BuildID of the snapshot the caller should treat as authoritative.
	// For the normal full-checkpoint path this is the build_id passed in
	// the request; for the unchanged path it is the previous snapshot's
	// build_id.
	PublishedBuildId string `protobuf:"bytes,2,opt,name=published_build_id,json=publishedBuildId,proto3" json:"published_build_id,omitempty"`
}
...
func (x *SandboxCheckpointResponse) GetUnchanged() bool {
	if x != nil {
		return x.Unchanged
	}
	return false
...
func (x *SandboxCheckpointResponse) GetPublishedBuildId() string {
	if x != nil {
		return x.PublishedBuildId
	}
	return ""
}
...
var file_orchestrator_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0x80, 0x01, 0x0a, 0x18, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x43, 0x68, 0x65,
	...
	,
	...
	0x64, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x73, 0x32, 0xbb, 0x03,
