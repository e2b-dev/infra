...
type SandboxConfig struct {
	...
	Volumes             []*SandboxVolume      `protobuf:"bytes,23,rep,name=volumes,proto3" json:"volumes,omitempty"`
}
...
func (x *SandboxConfig) GetVolumes() []*SandboxVolume {
	if x != nil {
		return x.Volumes
	}
	return nil
...
func (x *SandboxVolume) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SandboxVolume) ProtoMessage() {}

func (x *SandboxVolume) ProtoReflect() protoreflect.Message {
	mi := &file_orchestrator_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SandboxVolume.ProtoReflect.Descriptor instead.
func (*SandboxVolume) Descriptor() ([]byte, []int) {
	return file_orchestrator_proto_rawDescGZIP(), []int{1}
}

func (x *SandboxVolume) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *SandboxVolume) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
var file_orchestrator_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xc1, 0x08, 0x0a, 0x0d, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x43, 0x6f,
	...
	0x03, 0x52, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x88, 0x01, 0x01, 0x12, 0x28, 0x0a,
	0x07, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x73, 0x18, 0x17, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e,
	0x2e, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x52, 0x07,
	0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x73, 0x1a, 0x3a, 0x0a, 0x0c, 0x45, 0x6e, 0x76, 0x56, 0x61,
	...
	0x6e, 0x65, 0x74, 0x5f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x6e,
	0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x22, 0x37, 0x0a, 0x0d, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f,
	0x78, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
...
var file_orchestrator_proto_goTypes = []interface{}{
	...
	(*SandboxVolume)(nil),                   // 1: SandboxVolume
...
var file_orchestrator_proto_depIdxs = []int32{
	...
	1,  // 3: SandboxConfig.volumes:type_name -> SandboxVolume
