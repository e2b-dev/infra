...
var file_orchestrator_proto_rawDesc = []byte{
	...
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x22, 0x60, 0x0a, 0x12, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78,
...
var file_orchestrator_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_orchestrator_proto_goTypes = []interface{}{
	...
	(*SandboxCheckpointRequest)(nil),        // 10: SandboxCheckpointRequest
	(*SandboxCheckpointResponse)(nil),       // 11: SandboxCheckpointResponse
...
var file_orchestrator_proto_depIdxs = []int32{
	...
	22, // 7: SandboxCreateRequest.start_time:type_name -> google.protobuf.Timestamp
	22, // 8: SandboxCreateRequest.end_time:type_name -> google.protobuf.Timestamp
	22, // 9: SandboxUpdateRequest.end_time:type_name -> google.protobuf.Timestamp
	0,  // 10: RunningSandbox.config:type_name -> SandboxConfig
	22, // 11: RunningSandbox.start_time:type_name -> google.protobuf.Timestamp
	22, // 12: RunningSandbox.end_time:type_name -> google.protobuf.Timestamp
	12, // 13: SandboxListResponse.sandboxes:type_name -> RunningSandbox
	22, // 14: CachedBuildInfo.expiration_time:type_name -> google.protobuf.Timestamp
	14, // 15: SandboxListCachedBuildsResponse.builds:type_name -> CachedBuildInfo
	5,  // 16: SandboxService.Create:input_type -> SandboxCreateRequest
	7,  // 17: SandboxService.Update:input_type -> SandboxUpdateRequest
	23, // 18: SandboxService.List:input_type -> google.protobuf.Empty
	8,  // 19: SandboxService.Delete:input_type -> SandboxDeleteRequest
	9,  // 20: SandboxService.Pause:input_type -> SandboxPauseRequest
	10, // 21: SandboxService.Checkpoint:input_type -> SandboxCheckpointRequest
	23, // 22: SandboxService.ListCachedBuilds:input_type -> google.protobuf.Empty
	16, // 23: VolumeService.Create:input_type -> VolumeCreateRequest
	18, // 24: VolumeService.Delete:input_type -> VolumeDeleteRequest
	6,  // 25: SandboxService.Create:output_type -> SandboxCreateResponse
	23, // 26: SandboxService.Update:output_type -> google.protobuf.Empty
	13, // 27: SandboxService.List:output_type -> SandboxListResponse
	23, // 28: SandboxService.Delete:output_type -> google.protobuf.Empty
	23, // 29: SandboxService.Pause:output_type -> google.protobuf.Empty
	11, // 30: SandboxService.Checkpoint:output_type -> SandboxCheckpointResponse
	15, // 31: SandboxService.ListCachedBuilds:output_type -> SandboxListCachedBuildsResponse
	17, // 32: VolumeService.Create:output_type -> VolumeCreateResponse
	19, // 33: VolumeService.Delete:output_type -> VolumeDeleteResponse
