...
type ServiceInfoResponse struct {
	...
	ServiceRoles           []ServiceInfoRole      `protobuf:"varint,7,rep,packed,name=service_roles,json=serviceRoles,proto3,enum=ServiceInfoRole" json:"service_roles,omitempty"`
...
var file_orchestrator_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x52, 0x06, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x73, 0x22, 0x91, 0x04, 0x0a, 0x13, 0x53,
	...
	0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x53,
	...
	0x5f, 0x75, 0x73, 0x65, 0x64, 0x18, 0x14, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x6d, 0x65, 0x74,
	...
	0x64, 0x5f, 0x6d, 0x62, 0x18, 0x15, 0x20, 0x01, 0x28, 0x03, 0x52, 0x12, 0x6d, 0x65, 0x74, 0x72,
	...
	0x18, 0x16, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x44, 0x69,
	...
	0x18, 0x17, 0x20, 0x01, 0x28, 0x03, 0x52, 0x16, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x53, 0x61,
	...
	0x6f, 0x72, 0x10, 0x01, 0x32, 0xf6, 0x02, 0x0a, 0x0e, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78,
	...
	0x75, 0x69, 0x6c, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x98, 0x01,
...
var file_orchestrator_proto_goTypes = []interface{}{
	...
	(*SandboxUpdateRequest)(nil),            // 5: SandboxUpdateRequest
	(*SandboxDeleteRequest)(nil),            // 6: SandboxDeleteRequest
	(*SandboxPauseRequest)(nil),             // 7: SandboxPauseRequest
	...
	(*ServiceInfoResponse)(nil),             // 12: ServiceInfoResponse
	(*ServiceStatusChangeRequest)(nil),      // 13: ServiceStatusChangeRequest
...
var file_orchestrator_proto_depIdxs = []int32{
	...
	2,  // 2: SandboxCreateRequest.sandbox:type_name -> SandboxConfig
	16, // 3: SandboxCreateRequest.start_time:type_name -> google.protobuf.Timestamp
	16, // 4: SandboxCreateRequest.end_time:type_name -> google.protobuf.Timestamp
	16, // 5: SandboxUpdateRequest.end_time:type_name -> google.protobuf.Timestamp
	2,  // 6: RunningSandbox.config:type_name -> SandboxConfig
	16, // 7: RunningSandbox.start_time:type_name -> google.protobuf.Timestamp
	16, // 8: RunningSandbox.end_time:type_name -> google.protobuf.Timestamp
	8,  // 9: SandboxListResponse.sandboxes:type_name -> RunningSandbox
	16, // 10: CachedBuildInfo.expiration_time:type_name -> google.protobuf.Timestamp
	10, // 11: SandboxListCachedBuildsResponse.builds:type_name -> CachedBuildInfo
	0,  // 12: ServiceInfoResponse.service_status:type_name -> ServiceInfoStatus
	1,  // 13: ServiceInfoResponse.service_roles:type_name -> ServiceInfoRole
	16, // 14: ServiceInfoResponse.service_startup:type_name -> google.protobuf.Timestamp
	0,  // 15: ServiceStatusChangeRequest.service_status:type_name -> ServiceInfoStatus
	3,  // 16: SandboxService.Create:input_type -> SandboxCreateRequest
	5,  // 17: SandboxService.Update:input_type -> SandboxUpdateRequest
	17, // 18: SandboxService.List:input_type -> google.protobuf.Empty
	6,  // 19: SandboxService.Delete:input_type -> SandboxDeleteRequest
	7,  // 20: SandboxService.Pause:input_type -> SandboxPauseRequest
	17, // 21: SandboxService.ListCachedBuilds:input_type -> google.protobuf.Empty
	17, // 22: InfoService.ServiceInfo:input_type -> google.protobuf.Empty
	13, // 23: InfoService.ServiceStatusOverride:input_type -> ServiceStatusChangeRequest
	4,  // 24: SandboxService.Create:output_type -> SandboxCreateResponse
	17, // 25: SandboxService.Update:output_type -> google.protobuf.Empty
	9,  // 26: SandboxService.List:output_type -> SandboxListResponse
	17, // 27: SandboxService.Delete:output_type -> google.protobuf.Empty
	17, // 28: SandboxService.Pause:output_type -> google.protobuf.Empty
	11, // 29: SandboxService.ListCachedBuilds:output_type -> SandboxListCachedBuildsResponse
	12, // 30: InfoService.ServiceInfo:output_type -> ServiceInfoResponse
	17, // 31: InfoService.ServiceStatusOverride:output_type -> google.protobuf.Empty
