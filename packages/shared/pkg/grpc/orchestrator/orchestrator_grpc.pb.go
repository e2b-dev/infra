...
const (
	...
	SandboxService_DrainStatus_FullMethodName      = "/SandboxService/DrainStatus"
...
type SandboxServiceClient interface {
	...
	DrainStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SandboxDrainStatusResponse, error)
...
func (c *sandboxServiceClient) DrainStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SandboxDrainStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SandboxDrainStatusResponse)
	err := c.cc.Invoke(ctx, SandboxService_DrainStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SandboxServiceServer interface {
	...
	DrainStatus(context.Context, *emptypb.Empty) (*SandboxDrainStatusResponse, error)
...
func (UnimplementedSandboxServiceServer) DrainStatus(context.Context, *emptypb.Empty) (*SandboxDrainStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DrainStatus not implemented")
}
...
func _SandboxService_DrainStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SandboxServiceServer).DrainStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SandboxService_DrainStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SandboxServiceServer).DrainStatus(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SandboxService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DrainStatus",
			Handler:    _SandboxService_DrainStatus_Handler,
		},
		{
			MethodName: "Delete",
