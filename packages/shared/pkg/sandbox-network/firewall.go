...
const (
	...
	DefaultNameserver = consts.SandboxDefaultNameserver
)

// Backward-compatible name for the shared cross-runtime sandbox denylist.
var DeniedSandboxCIDRs = consts.SandboxDeniedCIDRs
