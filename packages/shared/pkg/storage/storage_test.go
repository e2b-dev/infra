...
func (_mock *MockStorageObjectProvider) ReadFrom(src io.Reader) (int64, error) {
...
func (_c *MockStorageObjectProvider_ReadFrom_Call) Run(run func(src io.Reader)) *MockStorageObjectProvider_ReadFrom_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 io.Reader
		if args[0] != nil {
...
func (_c *MockStorageObjectProvider_ReadFrom_Call) RunAndReturn(run func(src io.Reader) (int64, error)) *MockStorageObjectProvider_ReadFrom_Call {
	_c.Call.Return(run)
	return _c
}
