...
func (g *GCPBucketStorageProvider) UploadSignedURL(ctx context.Context, path string, ttl time.Duration) (string, error) {
...
func (g *GCPBucketStorageObjectProvider) ReadFrom(ctx context.Context, src []byte) (int64, error) {
