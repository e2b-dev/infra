...
type cachedSeekableObject struct {
	path      string
	chunkSize int64
	inner     Seekable
...
var _ Seekable = (*cachedSeekableObject)(nil)

func (c *cachedSeekableObject) ReadAt(ctx context.Context, buff []byte, offset int64) (n int, err error) {
...
func (c *cachedSeekableObject) Size(ctx context.Context) (n int64, e error) {
...
func (c *cachedSeekableObject) StoreFile(ctx context.Context, path string) (e error) {
...
func (c *cachedSeekableObject) goCtx(ctx context.Context, fn func(context.Context)) {
	c.wg.Go(func() {
		fn(context.WithoutCancel(ctx))
	})
}

func (c *cachedSeekableObject) makeChunkFilename(offset int64) string {
	return fmt.Sprintf("%s/%012d-%d.bin", c.path, offset/c.chunkSize, c.chunkSize)
}

func (c *cachedSeekableObject) makeTempChunkFilename(offset int64) string {
	tempFilename := uuid.NewString()

	return fmt.Sprintf("%s/.temp.%012d-%d.bin.%s", c.path, offset/c.chunkSize, c.chunkSize, tempFilename)
}

func (c *cachedSeekableObject) readAtFromCache(ctx context.Context, chunkPath string, buff []byte) (n int, e error) {
...
func (c *cachedSeekableObject) sizeFilename() string {
	return filepath.Join(c.path, "size.txt")
}

func (c *cachedSeekableObject) readLocalSize(context.Context) (int64, error) {
...
func (c *cachedSeekableObject) validateReadAtParams(buffSize, offset int64) error {
	if buffSize == 0 {
...
func (c *cachedSeekableObject) writeChunkToCache(ctx context.Context, offset int64, chunkPath string, bytes []byte) error {
...
func (c *cachedSeekableObject) writeLocalSize(ctx context.Context, size int64) error {
...
func (c *cachedSeekableObject) createCacheBlocksFromFile(ctx context.Context, inputPath string) (count int64, err error) {
...
// same machine..
func (c *cachedSeekableObject) writeChunkFromFile(ctx context.Context, offset int64, input *os.File) (err error) {
