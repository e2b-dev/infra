...
func DownloadFrames(ctx context.Context, src RangeGetter, start int64, n int, ft *FrameTable) (int64, [][]byte, error) {
	...
	nFrames := 0
	err := ft.Range(start, int64(n), func(off Offset, frame Frame) error {
		nFrames++
		return nil
	})
	if err != nil {
...
func downloadFrame(ctx context.Context, src RangeGetter, frameOffset Offset, frame Frame) ([]byte, error) {
