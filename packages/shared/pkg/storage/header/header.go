...
func (t *Header) getMapping(ctx context.Context, offset int64) (*BuildMap, int64, error) {
	...
	block := BlockIdx(offset, PageSize)
	...
	shift := (block - int64(start)) * PageSize
