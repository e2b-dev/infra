...
ALTER TABLE "public"."team_api_keys"
    ...
    ADD CONSTRAINT IF NOT EXISTS "team_api_keys_users_created_api_keys" FOREIGN KEY ("created_by") REFERENCES "auth"."users" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
