...
type CPUConfig struct {
	...
	CpuidModifiers any `json:"cpuid_modifiers,omitempty"`

	// A collection of kvm capabilities to be modified. (aarch64)
	KvmCapabilities any `json:"kvm_capabilities,omitempty"`

	// A collection of model specific registers to be modified. (x86_64)
	MsrModifiers any `json:"msr_modifiers,omitempty"`

	// A collection of registers to be modified. (aarch64)
	RegModifiers any `json:"reg_modifiers,omitempty"`

	// A collection of vcpu features to be modified. (aarch64)
	VcpuFeatures any `json:"vcpu_features,omitempty"`
}
