...
ALTER TABLE IF EXISTS public.published_templates NO FORCE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.published_templates DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.published_template_agents NO FORCE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.published_template_agents DISABLE ROW LEVEL SECURITY;
