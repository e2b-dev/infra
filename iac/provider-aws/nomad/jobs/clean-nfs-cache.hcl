        ...
        task "efs-cleanup" {
          ...
          config {
            ...
            artifact {
                ...
                source      = "s3::https://s3.${aws_region}.amazonaws.com/${bucket_name}/clean-nfs-cache?versionId=${clean_nfs_cache_checksum}"
                %{ else }
                source      = "s3::https://s3.${aws_region}.amazonaws.com/${bucket_name}/clean-nfs-cache"
                %{ endif }
              }
