...
module "dashboard_api" {
  ...
  clickhouse_connection_string            = local.clickhouse_connection_string
  supabase_jwt_secrets                    = trimspace(data.google_secret_manager_secret_version.supabase_jwt_secrets.secret_data)
  oauth_jwks_url                          = var.dashboard_api_oauth_jwks_url
  oauth_issuer                            = var.dashboard_api_oauth_issuer
  oauth_audience                          = var.dashboard_api_oauth_audience
  oauth_user_id_claim                     = var.dashboard_api_oauth_user_id_claim
  oauth_email_claim                       = var.dashboard_api_oauth_email_claim
  oauth_jwks_cache_duration               = var.dashboard_api_oauth_jwks_cache_duration
  redis_url                               = local.redis_url
  redis_cluster_url                       = local.redis_cluster_url
  redis_tls_ca_base64                     = trimspace(data.google_secret_manager_secret_version.redis_tls_ca_base64.secret_data)
